...
<link rel="stylesheet" href="/meetings/layui/css/layui.css" media="all">
 ...
 <div class="layui-card">
  <div class="layui-card-header" style="font-size:20px;color:#54b5ff">已发布会议</div>
  <div class="layui-card-body">
    ...
    <form class="layui-form" lay-filter="attendanceform">
	  ...
	  <button class='layui-btn layui-btn-ks'  id="doSearch">搜索</button>
	   ...
	   <table  style="margin:0px 0" id="publishedlist" lay-filter="publishedlist"></table>
...
<script>
    layui.use(['tree','table','layer','form','upload'], function(){
      ...
      //获取系统当前时间
       ...
       table.render({
            elem: '#publishedlist'
            ,url:'/meetings/meeting/published.do'
            ,title: '会议列表'
            ,height: 550
            ,method:'POST'
            ,cols: [
        ...
        table.on('tool(publishedlist)', function(obj){ 
        	  var data = obj.data; 
