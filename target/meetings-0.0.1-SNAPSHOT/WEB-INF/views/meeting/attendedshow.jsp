...
<link rel="stylesheet" href="/meetings/layui/css/layui.css" media="all">
 ...
 <div class="layui-card">
  <div class="layui-card-header" style="font-size:20px;color:#54b5ff">已报名会议</div>
  <div class="layui-card-body">
    ...
    <img id="QRCode">
	   <table  style="margin:0px 0" id="attendedlist" lay-filter="attendedlist"></table>
...
<script>
    layui.use(['tree','table','layer','form','upload'], function(){
      ...
      //获取系统当前时间
       ...
       table.render({
            elem: '#attendedlist'
            ,url:'/meetings/meeting/attended.do'
            ,title: '会议列表'
            ,height: 550
            ,method:'POST'
            ,cols: [
        ...
        table.on('tool(attendedlist)', function(obj){ 
        	  var data = obj.data; 
