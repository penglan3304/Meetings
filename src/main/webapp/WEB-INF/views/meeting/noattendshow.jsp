...
<link rel="stylesheet" href="${ctx}/layui/css/layui.css" media="all">
 ...
 <div class="layui-card">
  ...
  <div class="layui-card-body">
    ...
    <img id="QRCode">
	   <table  style="margin:0px 0" id="noattendlist" lay-filter="noattendlist"></table>
    ...
    layui.use(['tree','table','layer','form','upload'], function(){
      ...
      //获取系统当前时间
       ...
       table.render({
        ...
        table.on('tool(noattendlist)', function(obj){ 
        	  var data = obj.data; 
        	...
        	var id=data.id;
	      	   $.ajax({
	       		url: "${ctx}/meeting/sendMail.do?flag=0&id="+id,
	       		type: "POST",
	       		dataType: "json",
	      			success: function(data){            
	           		if(data==1){
	           			...
	           			$.ajax({
	        	       		url: "${ctx}/meeting/changestate.do?id="+id,
	        	       		type: "POST",
	        	       		dataType: "json",
	        	      			success: function(data){  
	        	      				if(data==0){
        	    ...
        	    layer.prompt({
        	    	...
        	    	$.ajax({
                		url: "${ctx}/meeting/absents.do?id="+data.id+"&reason="+value,
                		type: "POST",
                		dataType: "json",
               			success: function(data){            
                    		if(data==0){
