...
public class Zxing {
	//private static final int BLACK = 0x4169E1;//用于设置图案的颜色  
    ...
    private static final int WHITE = 0xFFFFFF; //用于背景色  
	  ...
	  public static BufferedImage toBufferedImage(BitMatrix matrix) {  
	    ...
	    public static void writeToFile(BitMatrix matrix, String format, File file,String bottom) throws IOException {  
